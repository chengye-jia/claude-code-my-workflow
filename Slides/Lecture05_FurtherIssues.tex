...
\begin{frame}[shrink=8]{Beta (Standardized) Coefficients: Definition}
...
\begin{frame}[shrink=8]{Beta Coefficients: Interpretation}
...
\begin{frame}[shrink=8]{Example 6.1 --- Effects of Pollution on Housing Prices}
...
\begin{frame}[shrink=8]{Exact vs.\ Approximate Percentage Changes}
...
\begin{frame}[shrink=8]{When to Use Logarithms: Rules of Thumb}
...
\begin{frame}[shrink=8]{Models with Quadratics}
...
\begin{frame}[shrink=8]{Wage--Experience Quadratic (WAGE1)}
...
\begin{frame}[shrink=8]{Important Lesson: Small Coefficients on $x^2$ Can Matter}
...
\begin{frame}[shrink=8]{Average Partial Effects (APE)}
...
\begin{frame}[shrink=8]{Centering Variables Before Creating Interactions}
...
\begin{frame}[shrink=8]{Choosing Between Nonnested Models}
...
\begin{frame}[shrink=8]{Over-Controlling: Adding Bad Controls}
...
\begin{frame}[shrink=8]{Adding Regressors to Reduce Error Variance}
...
\begin{frame}[shrink=8]{Confidence Intervals for Predictions}
...
\begin{frame}[shrink=8]{Example 6.5 --- Confidence Interval for Predicted College GPA}
...
\begin{frame}[shrink=8]{Prediction Intervals vs.\ Confidence Intervals}
...
\begin{frame}[shrink=8]{Residual Analysis}
...
\begin{frame}[shrink=8]{Bootstrap Standard Error: Algorithm and Formula}
...
\begin{frame}[shrink=8]{Bootstrap in Practice}
...
\begin{frame}[fragile, shrink=8]{R Code: Scaling and Beta Coefficients}
...
\begin{frame}[fragile, shrink=10]{R Code: Quadratic Models}
...
\begin{frame}[fragile, shrink=8]{R Code: Predictions and Log Models}
